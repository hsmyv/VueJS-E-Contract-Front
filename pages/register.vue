            ...
            <div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
                <div class="bg-white">
                    ...
                    <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                        ...
                        <TextInput v-model:input="name" inputType="name"
                    ...
                    <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
                        ...
                        <TextInput v-model:input="email" inputType="email"
                    ...
                    <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
                        ...
                        <TextInput v-model:input="password" inputType="password"
                    ...
                    <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
                            ...
                            <TextInput v-model:input="confirmPassword" inputType="password"
