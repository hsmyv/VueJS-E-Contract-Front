         ...
         <div class="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
                ...
                <div class="mt-8 md:flex gap-6">
                    ...
                    <label v-if="!fileDisplay" for="fileInput" @drop.prevent="onDrop" @dragover.prevent="" class="
                        ...
                        <div class="px-2 py-1.5 mt-8 text-white text-[15px] w-[80%] bg-blue-500 rounded-sm">
                            Select file
                        </div>
                    ...
                    <div class="mt-4 mb-6">
                        <div class="flex bg-[#F8F8F8] py-4 px-6">
                            ...
                            <div class="flex justify-end max-w-[130px] w-full h-full text-center my-auto">
                                <button class="px-8 py-1.5 text-white text-[15px] bg-blue-500 rounded-sm">
                                    Edit
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="flex gap-3">
                            ...
                            <button @click="createPost()"
                                class="px-10 py-2.5 mt-8 border text-[16px] text-white bg-blue-500 rounded-sm">
                                Post
                            </button>
                        </div>
