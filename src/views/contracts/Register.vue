...
<template>
	...
	<div class="h-screen md:flex">
		...
		<div class="flex md:w-1/2 justify-center py-10 items-center bg-white">
			<form @submit.prevent="handleRegister" class="bg-white">
				...
				<p class="text-sm font-normal text-gray-600 mb-7">Welcome Back</p>
					...
					<div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
						...
						<input class="pl-2 outline-none border-none" type="text" v-model="form.name" placeholder="Username" />
	      </div>
						<div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
							<svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none"
								viewBox="0 0 24 24" stroke="currentColor">
							...
							<input class="pl-2 outline-none border-none" type="text"  v-model="form.email" placeholder="Email Address" />
	      </div>
